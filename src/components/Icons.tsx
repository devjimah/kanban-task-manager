// Kanban Logo - Dark variant (dark text for light mode)
...
// Kanban Logo - Light variant (white text for dark mode)
...
// Show Sidebar Icon
export const IconShowSidebar = ({ className = "" }: { className?: string }) => (
  <svg
    width="16"
    height="11"
    xmlns="http://www.w3.org/2000/svg"
...
// Hide Sidebar Icon
export const IconHideSidebar = ({ className = "" }: { className?: string }) => (
  <svg
    width="18"
    height="16"
    xmlns="http://www.w3.org/2000/svg"
...
// Light Theme Icon
export const IconLightTheme = ({ className = "" }: { className?: string }) => (
  <svg
    width="19"
    height="19"
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      d="M9.167 15.833a.833.833 0 0 1 .833.834v.833a.833.833 0 0 1-1.667 0v-.833a.833.833 0 0 1 .834-.834ZM3.75 13.75a.833.833 0 0 1 .59 1.422l-.59.59a.833.833 0 0 1-1.179-1.18l.59-.59a.833.833 0 0 1 .59-.242Zm10.833 0c.221 0 .433.088.59.242l.59.59a.833.833 0 0 1-1.18 1.179l-.59-.59a.833.833 0 0 1 .59-1.421ZM9.167 5a4.167 4.167 0 1 1 0 8.334 4.167 4.167 0 0 1 0-8.334Zm-7.5 3.333a.833.833 0 0 1 0 1.667H.833a.833.833 0 1 1 0-1.667h.834Zm15.833 0a.833.833 0 0 1 0 1.667h-.833a.833.833 0 0 1 0-1.667h.833Zm-1.667-6.666a.833.833 0 0 1 .59 1.422l-.59.59a.833.833 0 1 1-1.179-1.18l.59-.59a.833.833 0 0 1 .59-.242Zm-12.5 0c.221 0 .433.088.59.242l.59.59a.833.833 0 0 1-1.18 1.179l-.59-.59a.833.833 0 0 1 .59-1.421ZM9.167 0A.833.833 0 0 1 10 .833v.834a.833.833 0 1 1-1.667 0V.833A.833.833 0 0 1 9.167 0Z"
      fill="#828FA3"
    />
  </svg>
);
...
// Dark Theme Icon
export const IconDarkTheme = ({ className = "" }: { className?: string }) => (
  <svg
    width="16"
    height="16"
    xmlns="http://www.w3.org/2000/svg"
